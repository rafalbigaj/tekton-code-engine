...
import (
	...
	"github.com/rafalbigaj/tekton-code-engine/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CustomV1alpha1Interface interface {
	RESTClient() rest.Interface
	CodeEngineTasksGetter
}
...
func (c *CustomV1alpha1Client) CodeEngineTasks(namespace string) CodeEngineTaskInterface {
	return newCodeEngineTasks(c, namespace)
}
...
// NewForConfigAndClient creates a new CustomV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CustomV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
